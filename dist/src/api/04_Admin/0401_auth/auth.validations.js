...
exports.SignIn = exports.LoginBody = void 0;
const celebrate_1 = require("celebrate");
const Validations = __importStar(require("../../../middleware/Validation.mw"));
exports.LoginBody = celebrate_1.Joi.object({
...
exports.SignIn = celebrate_1.Joi.object({
    sAdminEmail: Validations.CorrectEmail('Login sAdminEmail'),
    sAdminUsername: Validations.String('Login sAdminUsername'),
